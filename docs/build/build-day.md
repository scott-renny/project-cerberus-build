# Hardware Assembly Log

This is the hardware workstream of the broader Cerberus platform project.

## Arrivals

| Component | Status | Evidence / notes |
|---|---|---|
| MUSETEX K2 | **Owned — arrived** | Inspect chassis and retain included hardware |
| MSI MAG B850 Tomahawk MAX WiFi | **Owned — arrived** | Add sanitized photo when available |

## Before assembly

- [ ] Keep the motherboard in its anti-static packaging until bench work.
...
|---|---|---|
| Install CPU | Pending | AMD Ryzen 9 9900X |
| Install memory | Pending | Exact 64 GB kit selecting |
...
| Install primary GPU | Pending | Exact RTX 5060 Ti 16 GB selecting |
| Install secondary GPU | Pending | T400 preferred; P620 fallback |
...
Record symptoms, diagnostic steps, root cause, resolution, and verification. Remove identifying information from every public artifact.
