...
|---|---|---|---|
| POST | Multiple cold boots | Reliable detection and boot | Pending |
| Memory | Extended memory test | Zero errors | Pending |
| CPU | Sustained multicore load | Stable; temperatures within limits | Pending |
...
Record tools, versions, duration, ambient temperature, settings, and observations so results can be reproduced.
